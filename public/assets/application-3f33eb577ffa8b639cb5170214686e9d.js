...
(function() {
  $(document).ready(function() {
    ...
    $(window).bind("orientationchange throttledresize", function() {
      psw = $(window).width();
      psh = $(window).height();
      return $("header").height(psh).width(psw);
    });
    cw = $(".container").width();
    ...
    $("#nav-boxes a").hover((function() {
      return $(this).find("i").addClass("animated flipInY 1s");
    }), function() {
      return $(this).find("i").removeClass("animated flipInY 1s");
    });
    return $("header").scrollspy({
      target: ".navbar"
    });
  });
